...
def extract_shuba(text, branches):
    t = clean(text)
    shuba_topics = {
        'الصلاة وأحكامها': ['الصلاه','صلاه','اقيموا','الركوع','السجود','القبله','ركع','سجد','يصلون','صلوا','الجمعه'],
        'الزكاة والصدقات': ['الزكاه','زكاه','الصدقه','تصدق','النصاب','الفطر'],
        'الصوم وأحكامه': ['الصوم','الصيام','صام','رمضان','الافطار','السحور'],
        'الحج والعمرة': ['الحج','العمره','الكعبه','عرفه','الطواف','الاحرام','مناسك','منى'],
        'الطهارة والوضوء': ['الطهاره','الوضوء','الغسل','التيمم','النجاسه','طهور','الحيض'],
        'النكاح وأحكامه': ['النكاح','الزواج','تزوج','المهر','الزوجه','الولي','الخطبه'],
        'الطلاق والفرقة': ['الطلاق','طلق','الخلع','العده','الرجعه','اللعان'],
        'البيوع والتجارة': ['البيع','التجاره','الربا','الشراء','الدين','الرهن','الثمن'],
        'المواريث والفرائض': ['المواريث','الميراث','الورثه','الفرائض','التركه','يوصيكم'],
        'القصاص والحدود': ['القصاص','الحد','الحدود','الديه','السرقه','الزنا','القتل','الرجم'],
        'الجهاد والرباط': ['الجهاد','جاهدوا','القتال','الغزو','الرباط','الشهاده','قاتلوا'],
        'الإمامة والولاية': ['الامام','الخلافه','البيعه','الحاكم','اطيعوا','اولي الامر'],
        'التوحيد ونفي الشرك': ['التوحيد','الشرك','اشرك','الاصنام','احد','الصمد','وحده'],
        'الإيمان بالله': ['الايمان','امنوا','يؤمنون','المؤمنون','اتقوا الله'],
        'الإيمان بالغيب': ['الغيب','الملائكه','الجن','العرش','الكرسي','جبريل'],
        'النبوات والرسل': ['النبي','الرسول','الانبياء','المرسلين','النبوه','محمد','موسى','عيسى'],
        'اليوم الآخر والبعث': ['البعث','القيامه','الحشر','الحساب','الجنه','النار','الصراط','القبر'],
        'القضاء والقدر': ['القضاء','القدر','المشيئه','قدر','يشاء','الاجل'],
        'التقوى والإحسان': ['التقوى','اتقوا','الاحسان','المحسنين','البر','الورع'],
        'الأخلاق والآداب': ['الصدق','الامانه','الحياء','الصبر','الحلم','العفو','الكذب','الغيبه'],
        'الإنفاق والسخاء': ['الانفاق','انفقوا','السخاء','الكرم','رزقناهم','ينفقون'],
        'صلة الرحم والبر': ['الرحم','الوالدين','صله','الاقارب','الايتام','الجار'],
        'الدعاء والذكر': ['الدعاء','الذكر','التسبيح','الاستغفار','سبحان','الحمد'],
    }
    best_topic = None
    best_score = 0
