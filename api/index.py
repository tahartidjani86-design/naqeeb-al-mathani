...
def classify_dabit(text, asl_source):
    ...
    cmd = CMD_TERMS
    prh = PRH_TERMS
    jawaz_terms = ['استغفر لهم', 'لا تستغفر لهم', 'فلا جناح', 'فلا اثم', 'لا جناح', 'لا اثم', 'لا ينهاكم', 'اني شيتم', 'احل']
