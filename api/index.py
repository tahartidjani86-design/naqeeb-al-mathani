...
def classify_branch(text):
    ...
    tawhid_markers = ['لا اله الا','سبحان','يشركون','هو الله','الصمد','الاحد','احد','عالم الغيب','الاسماء الحسنى']
...
def extract_shuba(text, branches):
    ...
    shuba_topics = {
        ...
        "الإيمان بالله":          ['الايمان','امن','امنوا','يؤمنون','المؤمنون','الله','اتقوا الله','بالله'],
