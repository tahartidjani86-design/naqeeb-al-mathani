...
def classify_dabit(text, asl_source):
    ...
    dabits = []
    reasons = []
    cmd = ['افعلوا', 'اقيموا', 'اتوا', 'اطيعوا', 'امر', 'يامر', 'يامركم', 'امركم', 'كتب', 'كتب عليكم', 'فرض', 'اوجب', 'يجب', 'صلوا', 'ارجعوا', 'يوصيكم', 'وصاكم', 'اقم', 'انفقوا', 'اعبدوا', 'اتقوا', 'جاهدوا', 'اركعوا', 'اسجدوا', 'حافظوا', 'اوفوا', 'يوصي', 'قاتلوا']
    prh = ['نهي', 'ينهي', 'حرم', 'حرمت', 'لا تقربوا', 'لا تفعلوا', 'لا يحل', 'لا تقتلوا', 'لا تاكلوا', 'لا تشركوا', 'اجتنبوا', 'فاجتنبوه']
