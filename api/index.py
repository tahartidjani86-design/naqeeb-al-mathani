...
def classify_branch(text):
    ...
    present = sorted([s for s in scored if s[0] >= 1], key=lambda x: x[0], reverse=True)
    if present:
...
def extract_shuba(text, branches):
    ...
    shuba_topics = {
        ...
        "البيوع والتجارة":        ['البيع','بيع','التجاره','الربا','الشراء','الدين','السلم','الرهن','المعامله','اشترى','الثمن'],
        ...
        # العقائد (عقائدي)
        "التوحيد ونفي الشرك":     ['التوحيد','وحد','لا اله الا الله','الشرك','اشرك','الاصنام','العباده','احد','الصمد','وحده'],
